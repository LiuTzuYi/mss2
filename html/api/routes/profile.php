...
$app->get('/companyScore/{type}/{distance}/{start_date}/{end_date}', 'getCompanyScore')->setName('PROFILE - COMPANY SCORE');
...
$app->group('/driverScore/{type}/{distance}/{start_date}/{end_date}/{mode}', function() {
	$this->get('', 'getDriverScore')->setName('PROFILE - DRIVER SCORE');
/**
 ...
 **/
	...
	$this->get('/{id}', 'getDriverScore')->setName('PROFILE - DRIVER SCORE INDIVIDUAL');
/**
...
$app->group('/drvgrpScore/{type}/{distance}/{start_date}/{end_date}/{mode}', function() {
	$this->get('', 'getDrvGrpScore')->setName('PROFILE - DRIVERGRP SCORE');
/**
 ...
 * @apiUse UnauthorizedError
 */
	$this->get('/{id}', 'getDrvGrpScore')->setName('PROFILE - DRIVERGRP SCORE INDIVIDUAL');
/**
...
$app->group('/vehicleScore/{type}/{distance}/{start_date}/{end_date}/{mode}', function() {
	$this->get('', 'getVehicleScore')->setName('PROFILE - VEHICLE SCORE');
/**
 ...
 * @apiUse UnauthorizedError
 */
	$this->get('/{id}', 'getVehicleScore')->setName('PROFILE - VEHICLE SCORE INDIVIDUAL');
/**
...
$app->group('/vehgrpScore/{type}/{distance}/{start_date}/{end_date}/{mode}', function() {
	$this->get('', 'getVehGrpScore')->setName('PROFILE - VEHICLEGRP SCORE');
/**
 ...
 * @apiUse UnauthorizedError
 */
	$this->get('/{id}', 'getVehGrpScore')->setName('PROFILE - VEHICLEGRP SCORE INDIVIDUAL');
/**
...
$app->group('/warningRank/{type}/{distance}/{start_date}/{end_date}/{profile}', function() {
	$this->get('', 'getWarningRank')->setName('PROFILE - WARNING RANK');
/**
 ...
 * @apiUse UnauthorizedError
 */
	$this->get('/{id}', 'getWarningRank')->setName('PROFILE - WARNING RANK INDIVIDUAL');
/**
...
$app->get('/profileList/{profile}', 'getProfileList')->setName('PROFILE - GET FILTER LIST');
/**
 ...
 * @apiUse UnauthorizedError
 */
$app->get('/profileBase/{profile}/{id}', 'getProfileBaseInfo')->setName('PROFILE - GET INFO');
/**
...
$app->group('/CLP_profileVideo/{profile}/{start_date}/{end_date}', function() {
...
$app->group('/profileQuerySpecWarn/{profile}/{start_time}/{end_time}/{warn}', function() {
	$this->get('','querySpecWarnProfile')->setName('PROFILE - QUERY SPEC WARNING DETAIL');
/**
 ...
 * @apiUse UnauthorizedError
 */
	$this->get('/{id}','querySpecWarnProfile')->setName('PROFILE - QUERY SPEC WARNING DETAIL /W ID');
/**
...
function getCompanyScore (Request $request, Response $response, array $args){
	global $app;
	...
	$scoreCol = implode(", ", $setting['data']['fullScoreField']);
	$warnCol = implode(", ", $setting['data']['fullWarningField']);
...
function getDriverScore (Request $request, Response $response, array $args){
	global $app;
	$container = $app->getContainer();
	$setting = $container->get('settings');
	$prepOpts = $setting['db']['prepOpts'];
	...
	$scoreCol = implode(", avg.", $setting['data']['fullScoreField']);
	$warnCol = implode(", avg.", $setting['data']['fullWarningField']);
	$empty = false;
...
function getDrvGrpScore (Request $request, Response $response, array $args){
	global $app;
	$container = $app->getContainer();
	$setting = $container->get('settings');
	$prepOpts = $setting['db']['prepOpts'];
...
function getVehicleScore (Request $request, Response $response, array $args){
	global $app;
	$container = $app->getContainer();
	$setting = $container->get('settings');
	$prepOpts = $setting['db']['prepOpts'];
...
function getVehGrpScore (Request $request, Response $response, array $args){
	global $app;
	$container = $app->getContainer();
	$setting = $container->get('settings');
	$prepOpts = $setting['db']['prepOpts'];
...
function getWarningRank (Request $request, Response $response, array $args){
	global $app;
	$container = $app->getContainer();
	$setting = $container->get('settings');
	$prepOpts = $setting['db']['prepOpts'];
	...
	$warnCol = implode(", warn.", $setting['data']['fullWarningField']);
	$empty = false;
	$empty2 = false;
...
function getProfileList (Request $request, Response $response, array $args){
	global $app;
	$container = $app->getContainer();
	$setting = $container->get('settings');
	$prepOpts = $setting['db']['prepOpts'];
...
function getProfileBaseInfo (Request $request, Response $response, array $args){
	global $app;
	$container = $app->getContainer();
	$setting = $container->get('settings');
	$prepOpts = $setting['db']['prepOpts'];
...
function querySpecWarnProfile (Request $request, Response $response, array $args){
	global $app;
	$container = $app->getContainer();
	$setting = $container->get('settings');
	$prepOpts = $setting['db']['prepOpts'];
